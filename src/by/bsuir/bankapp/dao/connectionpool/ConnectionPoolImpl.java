...
public class ConnectionPoolImpl implements IConnectionPool {
    private static final Logger LOGGER = Logger.getLogger(ConnectionPoolImpl.class.getPackage().getName());

    private static final ConnectionPoolImpl instance = new ConnectionPoolImpl();

    /**
     * Synchronized queue of prepared free connections
     */
     ...
     */
    private class PooledConnection implements IPooledConnection {
        ...
        /**
         * Return connection to connections queue
         * @throws SQLException
         */
        @Override
